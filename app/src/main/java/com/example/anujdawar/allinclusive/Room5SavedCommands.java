...
public class Room5SavedCommands extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "Room5_details_database.db";
    public static final String TABLE_NAME = "Room5_Commands";
    ...
    public Room5SavedCommands(Context context)
    {
