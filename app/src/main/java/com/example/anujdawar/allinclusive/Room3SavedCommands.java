...
public class Room3SavedCommands extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "Room3_details_database.db";
    public static final String TABLE_NAME = "Room3_Commands";
    ...
    public Room3SavedCommands(Context context)
    {
