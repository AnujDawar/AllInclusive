...
public class Room1SavedCommands extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "Room1_details_database.db";
    public static final String TABLE_NAME = "Room1_Commands";
    ...
    public Room1SavedCommands(Context context)
    {
