...
public class Room4SavedCommands extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "Room4_details_database.db";
    public static final String TABLE_NAME = "Room4_Commands";
    ...
    public Room4SavedCommands(Context context)
    {
