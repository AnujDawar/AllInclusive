...
public class Room2SavedCommands extends SQLiteOpenHelper{

    public static final String DATABASE_NAME = "Room2_details_database.db";
    public static final String TABLE_NAME = "Room2_Commands";
    ...
    public Room2SavedCommands(Context context)
    {
